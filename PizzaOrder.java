/**
   This prProgram allows the user to order a pizza
*/
...
public class PizzaOrder
{
	public static void main (String [] args)
	{
		...
		String equalsIgnoreCase[] = {"Mike", "Diane"};
		...
		if (firstName.equals(equalsIgnoreCase))
                {    
                    discount = true;
                }
                else 
		...
		if (discount == true)
                {
                    System.out.println("You are eligiable for a $2.00 discount.");
                  System.out.println("Your cost with the discount is now $" + (cost-2));
                }
                else 
                {  
                    discount = false;
